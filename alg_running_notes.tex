...
I got distracted), this will mean we've solved the ILP rpoblem exactly,
...
\}$.
Any subset of items then have value $j\Delta$ for some $0\leq j \leq n^2 / 
\varepsilon$.
...
\subsection{Approximation to with a log-factor}
...
least-cardinality (least-weight) collection of $A_i$'s whose union
is $S$ (in the VC problem, these sets will be the set of vertices on an edge, 
I think).
