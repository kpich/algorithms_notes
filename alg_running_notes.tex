...
ILP is just liek LP, but the variables are required to take on integer values.
...
algorithm is known (the Decision Procedure version of the problem is NP-
complete, actually).
...
almost works sometimes. In general, though, this can yield a solution
...
Consider the problem UNSAT, which is in some sense the dual of SAT---
...
$NP$ (and, in fact, almost certainly isn't).
...
If we have such an $f$ that is poly-time computable, we wrote
$$
X \leq_P Y.
$$
