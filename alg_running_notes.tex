...
\begin{itemize}
	...
	The exchange property: Suppose we have two sets $A$ and $B$ with 
	...
	What is the maximum-weight schedulable subset of the tasks? We might
	not be able to meet all tasks of the schedule, so we ask what's the 
	max-weight one.
	...
	We don't have time for the exchange property.
