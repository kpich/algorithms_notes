...
For a vertext $u$, define $d(u)$ as the discovery time: the time
...
WE have thw following coloring scheme: until a vertex is discovered,
...
have overlapping nonnesting intervals---we have a call stack of vertices
being visited, and that's just how stacks work.

So the white path lemma is proved pretty straightforwardly from this
latter fact. We can use induction on the length of teh path between
$u$ and $v$.
