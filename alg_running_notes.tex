...
key in set, 0 otherwise); we won't be talking about auxiliary data today,
but we could store auxiliary data, and modify FIND to return a pointer to it.
...
this node''.
This gives us $O(\log u)$ SUCCESSOR, PREDECESSOR, MIN, and MAX; however, 
your other operations won't be $O(1)$ any more.
