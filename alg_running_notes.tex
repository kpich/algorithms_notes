...
c (r'(y) + r'(z) - (r(x) + r(y))).
$$
We have that $r'(y)$ and $r'(z)$ are each at most $r'(x)$ (for some reason I don't understand); 
we similarly have $r(y)$ and $r(x)$ being at most $r(x)$.
...
$\log_2(n)$.
In fact, the final rank of $x$ is
$$
